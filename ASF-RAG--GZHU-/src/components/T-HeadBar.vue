<template>
  <t-header class="shadow-sm bg-white border-b border-gray-200">
    <t-head-menu theme="light" :value="currentMenuItem" height="80px" class="flex items-center ">
      ...
      <t-menu-item value="itemacmd" @click="navigateTo('/data')"
        class="mx-1 px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200" :class="{
          'bg-blue-50 text-blue-600': $route.path === '/data',
          'text-gray-700 hover:bg-gray-100': $route.path !== '/data'
        }">
      ...
      <t-menu-item value="item3" @click="navigateTo('/Course')"
        class="mx-1 px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200" :class="{
          'bg-blue-50 text-blue-600': $route.path.startsWith('/Course'),
          'text-gray-700 hover:bg-gray-100': !$route.path.startsWith('/Course')
        }">
        <t-icon name="course" class="mr-2" />
        课程主页
      </t-menu-item>
